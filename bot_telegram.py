...
CATEGORIAS = [
    ...
    'Saúde', 'Lazer', 'Assinaturas', 'Imóvel',
    'Compras Online', 'Beleza', 'Pet', 'Outros'
]

PALAVRAS_CHAVE = {
    'Mercado':           ['mercado', 'supermercado', 'pão de açúcar', 'carrefour', 'extra',
                          'rappipro', 'rappi', 'cia italiana', 'frutaria',
                          'hortifruti', 'feira', 'atacadão', 'assaí', 'bistek', 'walmart',
                          'sam\'s', 'makro', 'tenda', 'dia ', 'prezunic', 'mundial',
                          'st marche', 'zone sul', 'bergamini', 'mambo', 'sonda',
                          'pao de acucar', 'g.barbosa', 'mateus', 'comper', 'breithaupt',
                          'angeloni', 'giassi', 'oba ', 'emporio', 'natural da terra'],
    'Restaurante':       ['restaurante', 'lanchonete', 'pizza', 'sushi', 'hamburguer', 'burger',
                          'ifood', 'ifd*', 'ifd ', 'delivery', 'cafe', 'café', 'padaria', 'bar ', 'bistrô',
                          'don ze', 'luan durb', 'vila leopoldina',
                          'churrascaria', 'pastelaria', 'espetinho', 'temaki', 'yakisoba',
                          'mcdonalds', 'mc donalds', 'burguer king', 'bk ', 'subway',
                          'outback', 'applebee', 'cvc ', 'rappi', 'james delivery',
                          'dominos', 'domino\'s', 'giraffas', 'bob\'s', 'habibs',
                          'jeronimo', 'madero', 'vivenda', 'fogo de chao', 'le pain',
    ...
    'Roupas':            ['roupa', 'zara', 'hm', 'h&m', 'renner', 'riachuelo', 'farm rio',
                          ...
                          'maria filo', 'amaro', 'dafiti', 'netshoes', 'centauro',
                          'decathlon', 'trilha', 'lupo', 'hope', 'moda', 'calcado',
                          'calçado', 'sapataria', 'usaflex', 'melissa', 'havaianas'],
    'Natação':           ['natação', 'natacao', 'piscina', 'swim', 'aula de natação'],
    'Escola':            ['escola', 'colégio', 'colegio', 'faculdade', 'curso',
                          'mensalidade', 'material escolar', 'livraria', 'saraiva',
                          'cultura ', 'fnac', 'amazon livros', 'udemy', 'alura',
                          'duolingo', 'kumon', 'wizard', 'berlitz', 'wise up'],
    'Viagem':            ['hotel', 'airbnb', 'passagem', 'aéreo', 'aereo', 'viagem',
                          'booking', 'decolar', 'latam', 'gol', 'azul', 'voo',
                          'expedia', 'trivago', 'trip.com', 'hostel', 'pousada',
                          'resort', 'emirates', 'tam ', 'avianca', 'copa airlines',
                          'aeroporto', 'transfer', 'seguro viagem', 'hurb'],
    'Casa Manutenção':   ['manutenção', 'manutencao', 'conserto', 'reparo', 'tinta',
                          'leroy', 'telha norte', 'ferragem', 'materiais', 'tok&stok',
                          'estok distrib',
                          'etna ', 'camicado', 'casa show', 'telhanorte', 'dicico',
                          'c&c ', 'bricolagem', 'ilha da madeira', 'quero-quero',
                          'sodimac', 'ln ', 'balaroti', 'madeirit', 'eletro'],
    'Casa Prestadores':  ['faxina', 'limpeza', 'jardineiro', 'pedreiro', 'eletricista',
                          'encanador', 'diarista', 'prestador', 'pintor', 'portaria',
                          'segurança', 'dedetiz', 'mudança', 'montagem'],
    'Carro':             ['gasolina', 'combustível', 'combustivel', 'posto ', 'ipva',
                          'seguro auto', 'estacionamento', 'uber', 'táxi', 'taxi',
                          'pedágio', 'pedagio', '99app', 'oficina', 'mecanica',
                          'vallet', 'vallets', 'valet', 'park ', 'parking', 'estacion',
                          'gyn vallet', 'b32 park', 'pjaguare', 'jaguar',
                          'shell ', 'ipiranga', 'br dist', 'petrobras', 'ale ',
                          'auto posto', 'lavagem', 'higieniz', 'borracharia',
                          'pneu', 'detran', 'licenciamento', 'gnv', 'etanol',
                          'sem parar', 'connect car', 'veloe', 'autopass'],
    'Saúde':             ['farmácia', 'farmacia', 'médico', 'medico', 'dentista',
                          'qualidoc',
                          'hospital', 'clínica', 'clinica', 'exame', 'plano de saúde',
                          'drogaria', 'ultrafarma', 'droga raia', 'drogasil',
                          'pacheco', 'nissei', 'panvel', 'pague menos', 'raia ',
                          'laboratorio', 'laboratório', 'consulta', 'psicol',
                          'nutri', 'fisio', 'ortopedia', 'otica', 'ótica',
                          'fleury', 'dasa ', 'hermes pardini', 'einstein',
                          'sirio', 'hcor', 'prevent senior', 'amil', 'unimed',
                          'bradesco saude', 'sulamerica saude', 'hapvida'],
    'Lazer':             ['cinema', 'teatro', 'show', 'parque', 'clube', 'academia',
                          'lazer', 'diversão', 'ingresso', 'smartfit', 'bodytech',
                          'bluefit', 'bio ritmo', 'totalpass', 'gympass', 'crossfit',
                          'ticketmaster', 'eventim', 'sympla', 'bilheteria',
                          'bowling', 'karting', 'laser', 'escape room', 'paintball',
                          'aquapark', 'zoologico', 'jardim botanico', 'museu',
                          'steam ', 'playstation', 'xbox', 'nintendo', 'nuuvem'],
    'Assinaturas':       ['netflix', 'spotify', 'amazon prime', 'disney', 'globoplay',
                          'hbo', 'paramount', 'apple', 'youtube premium',
                          'deezer', 'tidal', 'crunchyroll', 'mubi', 'telecine',
                          'directv', 'sky ', 'claro tv', 'vivo tv', 'oi tv',
                          'google one', 'icloud', 'dropbox', 'adobe', 'microsoft 365',
                          'antivirus', 'canva', 'chatgpt', 'openai'],
    'Imóvel':            ['imóvel', 'imovel', 'aluguel', 'condomínio', 'condominio',
                          'iptu', 'financiamento', 'escritura', 'cartório', 'cartorio',
                          'administradora', 'imobiliaria', 'imobiliária', 'sindico'],
    'Compras Online':    ['amazon', 'shopee', 'mercado livre', 'mercadolivre', 'americanas',
                          'aliexpress', 'dl *ali',
                          'submarino', 'magazine luiza', 'magalu', 'casas bahia',
                          'pontofrio', 'extra.com', 'kabum', 'aliexpress', 'shein',
                          'wish ', 'ebay', 'elo7', 'etsy', 'lojas americanas'],
    'Pet':               ['pet ', 'petshop', 'pet shop', 'magicpet', 'petz', 'cobasi',
                          'veterinari', 'vet ', 'animal', 'racao', 'ração', 'banho e tosa'],
    'Beleza':            ['salão', 'salao', 'cabeleireir', 'manicure', 'pedicure',
                          'estética', 'estetica', 'spa ', 'depilação', 'depilacao',
                          'sobrancelha', 'barbearia', 'perfumaria', 'sephora',
                          'o boticario', 'natura ', 'avon ', 'quem disse berenice',
                          'mahogany', 'loccitane', 'joy beauty', 'dermage'],
}
